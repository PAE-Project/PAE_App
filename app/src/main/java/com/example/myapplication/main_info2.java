...
public class main_info2 extends AppCompatActivity {
    ListView listView;
    Button go_register;
    ...
    class connect extends Thread {
        ...
        public void run() {
            try {
                URL url = new URL("http://3.35.45.245:8080/api/infos");
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    if(jsonObject.getString("category").equals("parenting")){
                    ...
                    public void run() {
                        ...
                        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                Intent intent = new Intent(main_info2.this, activity_info_detail.class);
