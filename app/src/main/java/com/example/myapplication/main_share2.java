...
public class main_share2 extends AppCompatActivity {
    ListView listView;
    Button go_register;
        ...
        public void run() {
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    if(jsonObject.getString("state").equals("나눔 중") || jsonObject.getString("state").equals("나눔 완료")){
                    ...
                    public void run() {
                        ...
                        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                Intent intent = new Intent(main_share2.this, activity_share_detail.class);
