...
public class main_board4 extends AppCompatActivity {
    ListView listView;
    Button go_register;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_board4);
        ...
        public void run() {
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    if(jsonObject.getString("category").equals("일상 정보")){
                    ...
                    public void run() {
                        ...
                        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                Intent intent = new Intent(main_board4.this, activity_board_detail.class);
